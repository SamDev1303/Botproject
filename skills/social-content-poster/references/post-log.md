# Post Log - Clean Up Bros

Track all social media posts to avoid repetition and monitor performance.
...
- **Type:** Before/After | Hack | Poll | POV | Testimonial | BTS
- **Caption:** [First line of caption]
- **Image:** [Description or filename]
- **Hashtags:** [Count]
- **Engagement (24hr):** Likes: X | Comments: X | Shares: X | Saves: X
...
| Month | Posts | Avg Likes | Avg Comments | Best Performer |
|-------|-------|-----------|--------------|----------------|
| Feb 2026 | 0 | - | - | - |
